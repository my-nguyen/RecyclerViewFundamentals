...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        sleepTrackerViewModel.nights.observe(viewLifecycleOwner, {
            ...
            it?.let {
                // adapter.nights = it
                // ListAdapter provides a method called submitList() to tell ListAdapter that a new
                // version of the list is available. When this method is called, the ListAdapter
                // diffs the new list against the old one and detects items that were added, removed,
                // moved, or changed. Then the ListAdapter updates the items shown by RecyclerView
